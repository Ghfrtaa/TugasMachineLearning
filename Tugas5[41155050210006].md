...
F1 = 2x Precission x recall / precission + recall
...
MCC = tp x tn + fp x fn / akar(tp + fp) x (tp + fn) x (tn + fp) x (tn + fn)
 
2.	Support Vector Machine (SVM)
2.1	Pengenalan Decision Boundary & Hyperlane
